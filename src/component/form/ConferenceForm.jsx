...
const ConferenceForm = () => {
  ...
  needShuttle:'', arrivalFlightNumber:'', arrivalBusDetails:'', arrivalDate:'', arrivalTime:'',departureFlightNumber:'',
  departureBusDetails:'', departureDate:'', departureTime:'',
  paymentType:'',        
  paymentMethod:''       
});
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FBF8F2] px-4">
      <div className="bg-white p-10 rounded-2xl shadow-xl text-center max-w-md animate-fade-in">
        ...
        <div className="bg-gray-100 rounded-lg p-4 mb-6 text-left text-sm">
          ...
          <p><strong>Total Fee:</strong> ₹ {getTotalAmount()}</p>
        </div>
    ...
    <div className="bg-white border border-gray-200 rounded-2xl shadow-md p-6">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <div className="space-y-1 md:col-span-2">
          <label className="text-sm text-gray-500">Bus Details</label>
          <input
            type="text"
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            ...
            <ReviewRow label="Assistance" value={p.needAssistance} />
            <ReviewRow label="Shuttle" value={p.needShuttle} />

            {(p.needShuttle === "Yes - Arrival only")? (
              <>
                <ReviewRow label="Flight" value={p.arrivalFlightNumber} />
                <ReviewRow label="Arrival Date" value={p.arrivalDate} />
                <ReviewRow label="Arrival Time" value={p.arrivalTime} />
                <ReviewRow label="Bus Details" value={p.arrivalBusDetails} />
              </>
            ):(p.needShuttle === "Yes - Departure only" )?(
            <>
                <ReviewRow label="Flight" value={p.departureFlightNumber} />
                <ReviewRow label="Departure Date" value={p.departureDate} />
                <ReviewRow label="Departure Time" value={p.departureTime} />
                <ReviewRow label="Bus Details" value={p.departureBusDetails} />
            </>
            ):
            (p.needShuttle === "Yes - Both arrival and departure")?
            <>
                <ReviewRow label="Arrival Flight" value={p.arrivalFlightNumber} />
                <ReviewRow label="Arrival Date" value={p.arrivalDate} />
                <ReviewRow label="Arrival Time" value={p.arrivalTime} />
                <ReviewRow label="Bus Details" value={p.arrivalBusDetails} />
                <ReviewRow label="Departure Flight" value={p.departureFlightNumber} />
                <ReviewRow label="Departure Date" value={p.departureDate} />
                <ReviewRow label="Departure Time" value={p.departureTime} />
                <ReviewRow label="Departure Bus Details" value={p.departureBusDetails} />
            </>:
            null}
          </div>
        </div>
