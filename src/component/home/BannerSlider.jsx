...
const BannerSlider = () => {
  ...
  return (
    ...
    text-white/80 mb-5 tracking-wide"
        ...
        {/* ---------------- SLIDE 3 ---------------- */}
        {slide === 2 && (
          <div className="flex flex-col justify-center md:justify-center items-center text-center px-4 sm:px-6 md:px-10 pt-10 sm:pt-12 md:pt-0 max-sm:mt-[100px] w-full h-full mb-5 sm:mb-0">
            {/* Heading */}
            ...
            <div className="grid grid-cols-1 grid-xs-1 sm:grid-cols-2 gap-3 sm:gap-4 w-full max-w-[280px] xs:max-w-md sm:max-w-xl md:max-w-2xl max-h-full md:max-h-full ">
              ...
              >
                <div className="w-full h-[220px] sm:h-[260px] md:h-[300px] bg-[#1B2B4B] overflow-hidden shrink-0 ">
                  <img
                    src={speaker1}
              ...
              >
                <div className="w-full h-[220px] sm:h-[260px] md:h-[300px] bg-[#1B2B4B] overflow-hidden shrink-0">
                  <img
                    ...
                    className="w-full h-full object-cover object-[50%_20%] transition-transform duration-500 group-hover:scale-110"
                  />
                </div>
                <div className="p-2.5 sm:p-3 text-center">
                  <h4 className="text-sm sm:text-base md:text-lg font-semibold hover:text-yellow-400 transition-colors duration-200 underline-offset-4 hover:underline decoration-yellow-400/50">
